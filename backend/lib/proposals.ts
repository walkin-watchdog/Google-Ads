...
export async function ensureDatabaseSchema(pool: Pool): Promise<void> {
    await pool.query(`
        ...
        CREATE TABLE IF NOT EXISTS strategy_success_rates (
            ...
            alpha NUMERIC DEFAULT 5.0,
            beta NUMERIC DEFAULT 5.0,
        ...
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS customer_id VARCHAR(50);
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS option_id VARCHAR(100);
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS feedback_type VARCHAR(40) NOT NULL DEFAULT 'context';
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS status VARCHAR(40) NOT NULL DEFAULT 'raw';
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS related_memory_id VARCHAR(120);
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS reviewed_by VARCHAR(80);
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS reviewer_note TEXT;
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
        ALTER TABLE proposal_feedback ADD COLUMN IF NOT EXISTS reviewed_at TIMESTAMP;

        ALTER TABLE impact_tracking ADD COLUMN IF NOT EXISTS lead_outcome_14 VARCHAR(50);
        ALTER TABLE impact_tracking ADD COLUMN IF NOT EXISTS lead_outcome_30 VARCHAR(50);
        ALTER TABLE impact_tracking ADD COLUMN IF NOT EXISTS lead_metrics_14 JSONB;
        ALTER TABLE impact_tracking ADD COLUMN IF NOT EXISTS lead_metrics_30 JSONB;
        ALTER TABLE impact_tracking ADD COLUMN IF NOT EXISTS outcome_details_14 JSONB;
        ALTER TABLE impact_tracking ADD COLUMN IF NOT EXISTS outcome_details_30 JSONB;
