        ...
        if (req.method === 'initialize') {
            ...
            try {
                    ...
                    tools: [
                        {
                            ...
                            description: 'Fetches the Google Ads dashboard data. Provide a section (e.g. "keywords", "searchTerms", "campaigns", "dailyTrend", "summary") to fetch full specific data without payload overload.',
                            inputSchema: { 
                                type: 'object', 
                                properties: {
                ...
                sendResponse(req.id, {
                    tools: [{
                        name: 'get_dashboard_data',
                        description: 'Fetches the Google Ads dashboard data. Provide a section to fetch specific data slices.',
                        inputSchema: { 
                            type: 'object', 
                            properties: {
                                section: { type: 'string' }
